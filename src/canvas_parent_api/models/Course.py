...
class Course(DataModel):
    def __init__(self, course_resp: CourseResponse):
        ...
        self._restrict_enrollments_to_course_dates = course_resp.restrict_enrollments_to_course_dates
        ...
        self._blueprint_restrictions_by_object_type = course_resp.blueprint_restrictions_by_object_type
